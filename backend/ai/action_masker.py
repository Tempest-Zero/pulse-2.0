...
class ActionMasker:
    ...
    def get_valid_actions(
        ...
        if db and user_id is not None:
            valid = self._filter_by_task_availability(valid, state, db, user_id)
    ...
    def _filter_by_task_availability(
        ...
        """
        Filter actions based on available tasks for the user.
    ...
    def get_preferred_actions(
        ...
        """
        valid = self.get_valid_actions(state, db, user_id)
